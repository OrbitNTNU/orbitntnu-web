  ...
  return (
    <header className="relative -mb-8">
      ...
      <div className="flex flex-col absolute top-20 left-6 lg:top-1/4 lg:left-64">
        <h1 className="text-gray-300 font-thin text-4xl uppercase -mb-2 z-10">
          {title}
        </h1>
        <h2 className="font-bold text-6xl uppercase z-10">{name}</h2>
        <p className="max-w-64 ml-1 z-10 text-lg">{text}</p>
      </div>
    </header>
  );
};
